...
The core numerical experiments (Figures~\ref{fig:oscillation}--\ref{fig:mmatrix})
are directly CTest-verified (13/13 tests pass). Figures~\ref{fig:xcothx}
and~\ref{fig:benchmark} are derived from CSV data generated by the same
verified code but are not individually CTest-gated.
Figures~\ref{fig:feature_matrix} and~\ref{fig:dependency} are
infrastructure analyses derived from document and code review.
All results are reproducible from committed source code; parameters for
each experiment are recorded in CSV metadata headers and summarized in
Table~\ref{tab:params}.

\begin{table}[htbp]
\centering
\caption{Experiment parameters. Values match CSV metadata headers in
  \texttt{QuantLib\_huatai/results/data/}.}
\label{tab:params}
\begin{tabular}{@{}llcccccc@{}}
\toprule
Experiment & Figures & $\sigma$ & $r$ & $K$ & $T$ & $N_x$ & Barriers \\
\midrule
Truncated call       & 1--2 & 0.001 & 0.05 & 50  & 5/12 & 200  & $U\!=\!70$ \\
Barrier (mod.\ vol)  & 3    & 0.25  & 0.05 & 100 & 0.5  & 2000 & $L\!=\!95,\,U\!=\!110$ \\
Barrier (low vol)    & 4    & 0.001 & 0.05 & 100 & 1.0  & 2000 & $L\!=\!95,\,U\!=\!110$ \\
Grid convergence     & 5    & 0.20  & 0.05 & 100 & 1.0  & 25--1600 & --- \\
Eff.\ diffusion      & 6    & 0.001 & 0.05 & --- & ---  & 200  & --- \\
M-matrix diagnostic  & 7    & 0.001 & 0.05 & --- & ---  & 200  & --- \\
Benchmark            & 8    & 0.20  & 0.05 & 100 & 1.0  & 25--1600 & --- \\
\bottomrule
\end{tabular}
\end{table}
